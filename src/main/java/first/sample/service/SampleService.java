...
public interface SampleService {
	...
	List<Map<String, Object>> searchFileList(Map<String, Object> map) throws Exception;
	
	List<BoardListAndFileListVO> seletBoardListAndFileListWithJoin(Map<String, Object> map) throws Exception;
